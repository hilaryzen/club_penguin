...
all: server.o client.o sema.o err.o processor.o render.o windowing.o
	gcc $(CFLAGS) -o server server.o sema.o err.o processor.o
	gcc $(CFLAGS) -o client client.o render.o err.o windowing.o -lncurses

server.o: server.c server.h sema.h err.h processor.h packets.h
	gcc $(CFLAGS) -c server.c
client.o: client.c client.h packets.h err.h windowing.h
...
windowing.o: windowing.c windowing.h
	gcc $(CFLAGS) -c windowing.c
